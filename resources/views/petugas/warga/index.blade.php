        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                <a href="{{ route('petugas.input-meter.index', ['rt_id' => $rtId]) }}" 
                   class="px-3 py-2 bg-sky-600 hover:bg-sky-500 text-white font-bold text-xs rounded-xl transition shadow-sm flex items-center gap-1.5">
                ...
                <table class="w-full text-left text-xs border-collapse">
                    <thead class="bg-slate-100 text-slate-700 uppercase font-black text-[10px] tracking-wider border-b-2 border-slate-300">
                        <tr>
                            ...
                            <th class="px-3 py-3 text-center min-w-[120px]">Aksi Cepat</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-slate-200">
                        ...
                        <tr class="hover:bg-sky-50/50 transition {{ $index % 2 == 0 ? 'bg-white' : 'bg-slate-50/40' }}">
                            ...
                            {{-- 4. Alamat --}}
                            <td class="px-3 py-2.5 text-left font-medium text-slate-800 text-xs">
                                {{ $warga->alamat }}
                            </td>
