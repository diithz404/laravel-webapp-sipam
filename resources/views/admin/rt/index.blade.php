...
@section('content')
<div class="space-y-4 sm:space-y-6" x-data="{ createModal: false, editModal: false, editRt: {} }">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
        @foreach($rts as $rt)
            <div class="bg-white rounded-2xl border-2 border-slate-200 shadow-md hover:shadow-xl hover:border-sky-300 transition p-4 sm:p-5 flex flex-col justify-between group">
                <div>
                    <div class="flex items-start justify-between">
                        <div>
                            ...
                            <h4 class="text-base sm:text-lg font-black text-slate-900 mt-1.5">{{ $rt->nama_rt }}</h4>
                    ...
                    <div class="mt-4 pt-3 border-t-2 border-slate-100">
                        ...
                        <div class="mt-2 space-y-1.5">
                            ...
                            @empty
                                <p class="text-xs text-amber-700 bg-amber-50 p-2 rounded-xl border border-amber-200 font-bold">Belum ada petugas RT</p>
                            @endforelse
                        </div>
                    </div>
                </div>
        ...
        <div class="flex items-center justify-center min-h-screen p-4 text-center">
            ...
            <div class="inline-block bg-white rounded-3xl text-left overflow-hidden shadow-2xl transform transition-all sm:max-w-lg sm:w-full border-2 border-slate-300 max-h-[90vh] flex flex-col my-6">
                ...
                <form action="{{ route('admin.rt.store') }}" method="POST" class="p-6 space-y-4 overflow-y-auto flex-1">
                    ...
                    <div>
                        <label class="block text-xs font-bold text-slate-700 uppercase mb-1">Nama RT / RW <span class="text-rose-500">*</span></label>
